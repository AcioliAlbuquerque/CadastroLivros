package br.com.ada.livros.shared.exception.handler;

import br.com.ada.livros.shared.exception.ExceptionMessage;
import br.com.ada.livros.shared.exception.FieldErrorMessage;
import br.com.ada.livros.shared.exception.FieldMessage;
...
public class ExceptionHandlerAdvice {
    ...
    public ResponseEntity<ExceptionMessage> exceptionNotFound(NotFoundException exception,
                                                              WebRequest request) {
    ...
    public ResponseEntity<FieldErrorMessage> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
                                                                          WebRequest request) {
